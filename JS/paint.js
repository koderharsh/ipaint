...
if(currentSize<10){
brushSize.innerHTML="0"+currentSize;
}
else{
brushSize.innerHTML=currentSize;
}
}
...
downloadBtn.addEventListener('click', () => {
  ...
  // downloadBtn.download='Myfile.png';
  downloadBtn.setAttribute('download', 'CanvasPaper.png');
